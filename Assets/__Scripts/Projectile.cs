...
public class Projectile : MonoBehaviour
{
    ...
    // This private List stores the history of the Projectile's move distance
    ...
    void FixedUpdate()
    {
        ...
        // Limit lookback; one of very few times that we use while
    ...
    {
        // If the explosion has already happened, exit
        if (hasExploded) return;

        // Mark that the explosion has occurred
        hasExploded = true;

        // Check if the explosion effect exists
